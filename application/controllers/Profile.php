...
class Profile extends MY_Controller 
{
    ...
    public function __construct() //dieksekusi sebelum mengakses halaman
    {
        parent::__construct();
    ...
    public function index() //nampilkan data profile ketika sudah login
    {
        $data['title']      = 'Profile';
    ...
    public function update($id)
    {
        ...
        if (!$data['content']) { //data yang tidak ada akan ditampilkan pesan 
            $this->session->set_flashdata('warning', 'Maaf data tidak ditemukan');
            redirect(base_url('profile'));
        }

        if (!$_POST) { //jika tidak menggunakan method POST akan memunculkan data saja
    ...
    public function unique_email() //menghindari duplikasi email
    {
