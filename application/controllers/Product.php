//Halaman Admin untuk mengedit Product
<?php
...
class Product extends MY_Controller
{
    ...
    public function index($page = null)
    {
        ...
        $data['content']    = $this->product->select(
                [
                    'product.id', 'product.title AS product_title', 'product.image', 'product.price', 'product.is_available', 'product.stock',
    ...
    public function search($page = null)// Query untuk mencari suatu data produk beserta kategorinya
    {
