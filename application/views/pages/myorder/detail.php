        ...
        <div class="col-md-9">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p>Tanggal Awal Penyewaan: <?= $order->dt_start ?></p>
                    <p>Tanggal Akhir Penyewaan: <?= $order->dt_end ?></p>
                    <p>Lama Penyewaan : <?= $order->dt_interval ?> Hari</p>
                    <table class="table">
                        <thead>
                            <tr>
                                <th>Produk</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center"><strong>Rp.<?= number_format($order->total  * $order->dt_interval, 0, ',', '.') ?>,-</strong></td>
                                <td></td>
                            </tr>
                        </tbody>
                    </table>
