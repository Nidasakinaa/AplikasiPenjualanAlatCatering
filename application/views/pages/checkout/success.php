        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <ol>
                        <li>Lakukan pembayaran pada rekening <strong>BCA 123901249421</strong> a/n PT. NS Catering</li>
                        <li>Sertakan keterangan dengan nomor order: <strong><?= $content->invoice ?></strong></li>
                        <li>Total pembayaran: <strong>Rp.<?= number_format($content->total * $content->dt_interval , 0, ',', '.') ?>,-</strong></li>
                    </ol>
